...
| ------------------- | ---------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `SmoothFlowTests`   | none (pure)                                                                  | frame codec, store reducer, notifier, daemon address, the child supervisor's TERM→KILL escalation (run for real around a scripted daemon)                                                                                                                                                                                                                                                                 |
