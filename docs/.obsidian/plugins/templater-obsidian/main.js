...
var Ta = (n, e) => {
    ...
    ka = (n, e, t) => {
        if ((e && typeof e == 'object') || typeof e == 'function')
            for (let r of wa(e)) !Ea.call(n, r) && r !== 'default' && Yn(n, r, { get: () => e[r], enumerable: !(t = va(e, r)) || t.enumerable });
        return n;
    },
    X = (n) =>
        ka(
            zi(
                Yn(
                    n != null ? ja(ba(n)) : {},
                    'default',
                    n && n.__esModule && 'default' in n ? { get: () => n.default, enumerable: !0 } : { value: n, enumerable: !0 },
                ),
            ),
            n,
        );
var Ji = (() => {
    ...
    return (t) => {
        for (var r = t.length, i = new Uint8Array((((r - (t[r - 1] == '=') - (t[r - 2] == '=')) * 3) / 4) | 0), o = 0, a = 0; o < r; ) {
...
var P = class extends Error {
    constructor(e, t) {
        super(e);
        this.console_msg = t;
        ((this.name = this.constructor.name), Error.captureStackTrace && Error.captureStackTrace(this, this.constructor));
    }
};
...
var re = (function () {
    ...
    return (
        (n.explainIfInvalidTSDocTagName = function (e) {
            ...
            if (!n._tsdocTagNameRegExp.test(e)) return 'A TSDoc tag name must start with a letter and contain only letters and numbers';
        }),
        ...
        (n.explainIfInvalidHtmlName = function (e) {
            if (!n._htmlNameRegExp.test(e)) return 'An HTML name must be an ASCII letter followed by zero or more letters, digits, or hyphens';
        }),
        ...
        (n.explainIfInvalidPackageName = function (e) {
            ...
            if (!n._validPackageNameRegExp.test(e)) return 'The package name '.concat(JSON.stringify(e), ' is not a valid package name');
        }),
        (n.explainIfInvalidImportPath = function (e, t) {
            if (e.length > 0) {
                ...
                if (!t && e[0] === '/') return 'An import path must not start with "/" unless prefixed by a package name';
            }
        }),
        ...
        (n.explainIfInvalidUnquotedMemberIdentifier = function (e) {
            ...
            if (n.isSystemSelector(e)) return 'The identifier "'.concat(e, '" must be quoted because it is a TSDoc system selector name');
        }),
        ...
        (n._systemSelectors = new Set(['instance', 'static', 'constructor', 'class', 'enum', 'function', 'interface', 'namespace', 'type', 'variable'])),
        n
    );
})();
var Nr = (function () {
    ...
    return (
        (n.prototype.registerDocNodes = function (e, t) {
            ...
            for (var i = 0, o = t; i < o.length; i++) {
                ...
                if (l !== void 0) throw new Error('The DocNode kind "'.concat(a.docNodeKind, '" was already registered') + ' by '.concat(l.packageName));
                if (((l = this._docNodeDefinitionsByConstructor.get(a.constructor)), l !== void 0))
                    throw new Error('This DocNode constructor was already registered by '.concat(l.packageName) + ' as '.concat(l.docNodeKind));
                var c = { docNodeKind: a.docNodeKind, constructor: a.constructor, packageName: e, allowedChildKinds: new Set() };
                (this._docNodeDefinitionsByKind.set(a.docNodeKind, c), this._docNodeDefinitionsByConstructor.set(a.constructor, c));
            }
        }),
        (n.prototype.throwIfNotRegisteredKind = function (e) {
            if (!this._docNodeDefinitionsByKind.has(e)) throw new Error('The DocNode kind "'.concat(e, '" was not registered with this TSDocConfiguration'));
        }),
        ...
        (n.prototype._getDefinition = function (e) {
            ...
            if (t === void 0) throw new Error('The DocNode kind "'.concat(e, '" was not registered with this TSDocConfiguration'));
            return t;
        }),
...
var R;
(function (n) {
    ((n[(n.InlineTag = 0)] = 'InlineTag'), (n[(n.BlockTag = 1)] = 'BlockTag'), (n[(n.ModifierTag = 2)] = 'ModifierTag'));
})(R || (R = {}));
var Mr = (function () {
    function n(e) {
...
var G = (function () {
    ...
    return (
        ...
        (n.decorator = n._defineTag({ tagName: '@decorator', syntaxKind: R.BlockTag, allowMultiple: !0, standardization: U.Extended })),
        ...
        (n.eventProperty = n._defineTag({ tagName: '@eventProperty', syntaxKind: R.ModifierTag, standardization: U.Extended })),
        (n.example = n._defineTag({ tagName: '@example', syntaxKind: R.BlockTag, allowMultiple: !0, standardization: U.Extended })),
        (n.experimental = n._defineTag({ tagName: '@experimental', syntaxKind: R.ModifierTag, standardization: U.Discretionary })),
        (n.inheritDoc = n._defineTag({ tagName: '@inheritDoc', syntaxKind: R.InlineTag, standardization: U.Extended })),
        (n.internal = n._defineTag({ tagName: '@internal', syntaxKind: R.ModifierTag, standardization: U.Discretionary })),
        (n.label = n._defineTag({ tagName: '@label', syntaxKind: R.InlineTag, standardization: U.Core })),
        (n.link = n._defineTag({ tagName: '@link', syntaxKind: R.InlineTag, allowMultiple: !0, standardization: U.Core })),
        (n.override = n._defineTag({ tagName: '@override', syntaxKind: R.ModifierTag, standardization: U.Extended })),
        (n.packageDocumentation = n._defineTag({ tagName: '@packageDocumentation', syntaxKind: R.ModifierTag, standardization: U.Core })),
        (n.param = n._defineTag({ tagName: '@param', syntaxKind: R.BlockTag, allowMultiple: !0, standardization: U.Core })),
        (n.privateRemarks = n._defineTag({ tagName: '@privateRemarks', syntaxKind: R.BlockTag, standardization: U.Core })),
        ...
        (n.throws = n._defineTag({ tagName: '@throws', syntaxKind: R.BlockTag, allowMultiple: !0, standardization: U.Extended })),
        (n.typeParam = n._defineTag({ tagName: '@typeParam', syntaxKind: R.BlockTag, allowMultiple: !0, standardization: U.Core })),
...
var Br = (function () {
    ...
    return (
        ...
        (n.prototype._requireTagToBeDefined = function (e) {
            var t = this._tagDefinitionsByName.get(e.tagNameWithUpperCase);
            if (!(t && t === e)) throw new Error('The specified TSDocTagDefinition is not defined for this TSDocConfiguration');
        }),
        n
    );
})();
var Ir = (function () {
    ...
    return (
        ...
        (n.prototype.addTag = function (e) {
            return this._nodesByName.has(e.tagNameWithUpperCase) ? !1 : (this._nodesByName.set(e.tagNameWithUpperCase, e), this._nodes.push(e), !0);
        }),
        n
    );
})();
        ...
        return (
            ...
            (e.prototype.appendNode = function (t) {
                if (!this.configuration.docNodeManager.isAllowedChild(this.kind, t.kind))
                    throw new Error('The TSDocConfiguration does not allow a '.concat(this.kind, ' node to') + ' contain a node of type '.concat(t.kind));
                this._nodes.push(t);
            }),
    ...
    Un = (function (n) {
        ...
        function e(t) {
            ...
            return (
                ...
                T.isParsedParameters(t) && (r._tagNameExcerpt = new j({ configuration: r.configuration, excerptKind: y.BlockTag, content: t.tagNameExcerpt })),
                r
            );
        }
        return (
            ...
            (e.prototype.getTokenSequence = function () {
                if (!this._tagNameExcerpt) throw new Error('DocBlockTag.getTokenSequence() failed because this object did not originate from a parsed input');
            ...
            return (
                T.isParsedParameters(t)
                    ? ((r._openingDelimiterExcerpt = new j({
                      ...
                      (r._codeExcerpt = new j({ configuration: r.configuration, excerptKind: y.CodeSpan_Code, content: t.codeExcerpt })),
            ...
            for (var t = [], r = !1, i = [], o = [], a = !1, l = 0, c = e.nodes; l < c.length; l++) {
                ...
                switch (d.kind) {
                    case g.PlainText:
                        ...
                        (w && a && (r = !0), S.length > 0 && (r && (i.push(' '), (r = !1)), i.push(S), o.push(d), (a = !0)), b && a && (r = !0));
                        break;
                    case g.SoftBreak:
                        (a && (r = !0), o.push(d));
                        break;
                    default:
                        (r && (i.push(' '), (r = !1)),
                            i.length > 0 && (t.push(new Ve({ configuration: e.configuration, text: i.join('') })), (i.length = 0), (o.length = 0)),
                            t.push(d),
                            (a = !0));
                }
            }
...
var Lr = function (n, e, t) {
    ...
    he;
(function (n) {
    ((n[(n.Closed = 0)] = 'Closed'), (n[(n.StartOfLine = 1)] = 'StartOfLine'), (n[(n.MiddleOfLine = 2)] = 'MiddleOfLine'));
})(he || (he = {}));
var lt = (function () {
    function n() {
        ((this.eol = `
    ...
    return (
                ...
                switch (e.kind) {
                    case g.Block:
                        ...
                        (this._ensureLineSkipped(),
                            ...
                            r.blockTag.tagNameWithUpperCase === G.returns.tagNameWithUpperCase && (this._writeContent(' '), (this._hangingParagraph = !0)),
                    ...
                    case g.Comment:
                        ...
                        (this._renderNodes(
                            Lr(
                                Lr(
                                    Lr(
                                        [a.summarySection, a.remarksBlock, a.privateRemarks, a.deprecatedBlock, a.params, a.typeParams, a.returnsBlock],
                                        a.customBlocks,
                                        !0,
                                    ),
                                    a.seeBlocks,
                            ...
                            a.modifierTagSet.nodes.length > 0 && (this._ensureLineSkipped(), this._renderNodes(a.modifierTagSet.nodes)));
                        break;
                    ...
                    case g.HtmlStartTag:
                        ...
                        for (var S = b.spacingAfterName === void 0 || b.spacingAfterName.length === 0, k = 0, E = b.htmlAttributes; k < E.length; k++) {
                            var O = E[k];
                            (S && this._writeContent(' '), this._renderNode(O), (S = O.spacingAfterValue === void 0 || O.spacingAfterValue.length === 0));
                        }
                        ...
                        this._renderInlineTag(D, function () {
                            ((D.urlDestination !== void 0 || D.codeDestination !== void 0) &&
                                (D.urlDestination !== void 0
                                    ...
                                    : D.codeDestination !== void 0 && (t._writeContent(' '), t._renderNode(D.codeDestination))),
                                D.linkText !== void 0 && (t._writeContent(' '), t._writeContent('|'), t._writeContent(' '), t._writeContent(D.linkText)));
                        });
                        break;
                    case g.MemberIdentifier:
                        var H = e;
                        H.hasQuotes ? (this._writeContent('"'), this._writeContent(H.identifier), this._writeContent('"')) : this._writeContent(H.identifier);
                        break;
                    case g.MemberReference:
                        ...
                        (F.hasDot && this._writeContent('.'),
                            ...
                            F.selector && (this._writeContent(':'), this._renderNode(F.selector), this._writeContent(')')));
                        break;
        ...
        (n.prototype._writeContent = function (e) {
            if (!(e === void 0 || e.length === 0)) {
                ...
                (this._lineState === he.Closed &&
                    (this._emitCommentFraming && this._output.append('/**' + this.eol + ' *'), (this._lineState = he.StartOfLine)),
        ...
        (n.prototype._writeNewline = function () {
            (this._lineState === he.Closed && (this._emitCommentFraming && this._output.append('/**' + this.eol + ' *'), (this._lineState = he.StartOfLine)),
        ...
        (n.prototype._writeEnd = function () {
            (this._lineState === he.MiddleOfLine && this._emitCommentFraming && this._writeNewline(),
                this._lineState !== he.Closed && (this._emitCommentFraming && this._output.append('/' + this.eol), (this._lineState = he.Closed)));
        }),
        n
    );
})();
    ...
    Vn = (function (n) {
        ...
        return (
            ...
            Object.defineProperty(e.prototype, 'importPath', {
                get: function () {
                    return (
                        this._importPath === void 0 && this._importPathExcerpt !== void 0 && (this._importPath = this._importPathExcerpt.content.toString()),
                        this._importPath
                    );
                },
                enumerable: !1,
            ...
            (e.prototype.onGetChildNodes = function () {
                return La(
                    [this._packageNameExcerpt, this._importPathExcerpt, this._importHashExcerpt, this._spacingAfterImportHashExcerpt],
...
var Ha = (function () {
    ...
    Pt = (function (n) {
        ...
        function e(t) {
            var r = n.call(this, t) || this;
            return (
                (r._textExcerpt = new j({ configuration: r.configuration, excerptKind: y.ErrorText, content: t.textExcerpt })),
...
var zn = (function (n) {
    ...
    function e(t) {
        ...
        return (
            ...
            (r._encodedTextExcerpt = new j({ configuration: r.configuration, excerptKind: y.EscapedText, content: t.encodedTextExcerpt })),
    ...
    return (
        ...
        Object.defineProperty(e.prototype, 'encodedText', {
            get: function () {
                return (this._encodedText === void 0 && (this._encodedText = this._encodedTextExcerpt.content.toString()), this._encodedText);
            },
            enumerable: !1,
            configurable: !0,
        }),
...
var Ka = (function () {
    ...
    Jn = (function (n) {
            ...
            return (
                T.isParsedParameters(t)
                    ? ((r._openingFenceExcerpt = new j({
                      ...
                      t.languageExcerpt &&
                          (r._languageExcerpt = new j({ configuration: r.configuration, excerptKind: y.FencedCode_Language, content: t.languageExcerpt })),
                      ...
                      (r._codeExcerpt = new j({ configuration: r.configuration, excerptKind: y.FencedCode_Code, content: t.codeExcerpt })),
        ...
        return (
                ...
                get: function () {
                    return (
                        this._language === void 0 &&
                            (this._languageExcerpt !== void 0 ? (this._language = this._languageExcerpt.content.toString()) : (this._language = '')),
                        this._language
                    );
                },
                enumerable: !1,
            ...
            Object.defineProperty(e.prototype, 'code', {
                get: function () {
                    return (this._code === void 0 && this._codeExcerpt !== void 0 && (this._code = this._codeExcerpt.content.toString()), this._code);
                },
                enumerable: !1,
                configurable: !0,
            }),
...
var Ra = (function () {
    ...
    Qn = (function (n) {
        ...
        function e(t) {
            ...
            return (
                T.isParsedParameters(t)
                    ? ((r._nameExcerpt = new j({ configuration: r.configuration, excerptKind: y.HtmlAttribute_Name, content: t.nameExcerpt })),
                      t.spacingAfterNameExcerpt &&
                          (r._spacingAfterNameExcerpt = new j({ configuration: r.configuration, excerptKind: y.Spacing, content: t.spacingAfterNameExcerpt })),
                      (r._equalsExcerpt = new j({ configuration: r.configuration, excerptKind: y.HtmlAttribute_Equals, content: t.equalsExcerpt })),
                      ...
                      (r._valueExcerpt = new j({ configuration: r.configuration, excerptKind: y.HtmlAttribute_Value, content: t.valueExcerpt })),
        ...
        return (
            ...
            Object.defineProperty(e.prototype, 'value', {
                get: function () {
                    return (this._value === void 0 && (this._value = this._valueExcerpt.content.toString()), this._value);
                },
                enumerable: !1,
                configurable: !0,
            }),
...
var Ya = (function () {
    ...
    Xn = (function (n) {
            ...
            return (
                T.isParsedParameters(t)
                    ? ((r._openingDelimiterExcerpt = new j({
                      ...
                      (r._nameExcerpt = new j({ configuration: r.configuration, excerptKind: y.HtmlEndTag_Name, content: t.nameExcerpt })),
                      t.spacingAfterNameExcerpt &&
                          (r._spacingAfterNameExcerpt = new j({ configuration: r.configuration, excerptKind: y.Spacing, content: t.spacingAfterNameExcerpt })),
                      (r._closingDelimiterExcerpt = new j({
                          configuration: r.configuration,
        ...
        return (
            ...
            (e.prototype.onGetChildNodes = function () {
                return [this._openingDelimiterExcerpt, this._nameExcerpt, this._spacingAfterNameExcerpt, this._closingDelimiterExcerpt];
            }),
            e
        );
    })(T);
var Ua = (function () {
    ...
    Zn = (function (n) {
            ...
            return (
                T.isParsedParameters(t)
                    ? ((i._openingDelimiterExcerpt = new j({
                      ...
                      (i._nameExcerpt = new j({ configuration: i.configuration, excerptKind: y.HtmlStartTag_Name, content: t.nameExcerpt })),
                      t.spacingAfterNameExcerpt &&
                          (i._spacingAfterNameExcerpt = new j({ configuration: i.configuration, excerptKind: y.Spacing, content: t.spacingAfterNameExcerpt })),
        ...
        return (
            ...
            (e.prototype.onGetChildNodes = function () {
                return to(
                    to([this._openingDelimiterExcerpt, this._nameExcerpt, this._spacingAfterNameExcerpt], this._htmlAttributes, !0),
...
var Ga = (function () {
    ...
    Qt = (function (n) {
        ...
        function e(t) {
            ...
            return (
                ...
                T.isParsedParameters(t) &&
                    ...
                    (r._tagNameExcerpt = new j({ configuration: r.configuration, excerptKind: y.InlineTag_TagName, content: t.tagNameExcerpt })),
        ...
        return (
            ...
            (e.prototype.onGetChildNodes = function () {
                return no(
                    no([this._openingDelimiterExcerpt, this._tagNameExcerpt, this._spacingAfterTagNameExcerpt], this.getChildNodesForContent(), !0),
                    [this._closingDelimiterExcerpt],
                    !1,
                );
            }),
...
var Wa = (function () {
    ...
    gn = (function (n) {
        ...
        function e(t) {
            var r = n.call(this, t) || this;
            if (r.tagNameWithUpperCase !== '@INHERITDOC') throw new Error('DocInheritDocTag requires the tag name to be "{@inheritDoc}"');
    ...
    Jt = (function (n) {
        ...
        function e(t) {
            ...
            return (
                T.isParsedParameters(t)
                    ? t.tagContentExcerpt &&
                      (r._tagContentExcerpt = new j({ configuration: r.configuration, excerptKind: y.InlineTag_TagContent, content: t.tagContentExcerpt }))
    ...
    er = (function (n) {
        ...
        function e(t) {
            ...
            if (((r._codeDestination = t.codeDestination), T.isParsedParameters(t))) {
                ...
                (t.urlDestinationExcerpt &&
                    ...
                    t.pipeExcerpt && (r._pipeExcerpt = new j({ configuration: r.configuration, excerptKind: y.LinkTag_Pipe, content: t.pipeExcerpt })),
                    t.spacingAfterPipeExcerpt &&
                        (r._spacingAfterPipeExcerpt = new j({ configuration: r.configuration, excerptKind: y.Spacing, content: t.spacingAfterPipeExcerpt })),
                    t.linkTextExcerpt &&
                        (r._linkTextExcerpt = new j({ configuration: r.configuration, excerptKind: y.LinkTag_LinkText, content: t.linkTextExcerpt })),
        ...
        return (
            ...
            Object.defineProperty(e.prototype, 'linkText', {
                get: function () {
                    return (
                        this._linkText === void 0 && this._linkTextExcerpt !== void 0 && (this._linkText = this._linkTextExcerpt.content.toString()),
                        this._linkText
                    );
                },
                enumerable: !1,
    ...
    hn = (function (n) {
        ...
        return (
            ...
            Object.defineProperty(e.prototype, 'identifier', {
                get: function () {
                    return (this._identifier === void 0 && (this._identifier = this._identifierExcerpt.content.toString()), this._identifier);
                },
                enumerable: !1,
                configurable: !0,
            }),
            ...
            return (
                T.isParsedParameters(t)
                    ? ((r._hasDot = !!t.dotExcerpt),
                      t.dotExcerpt && (r._dotExcerpt = new j({ configuration: r.configuration, excerptKind: y.MemberReference_Dot, content: t.dotExcerpt })),
                      t.spacingAfterDotExcerpt &&
                          (r._spacingAfterDotExcerpt = new j({ configuration: r.configuration, excerptKind: y.Spacing, content: t.spacingAfterDotExcerpt })),
                      ...
                      t.colonExcerpt &&
                          (r._colonExcerpt = new j({ excerptKind: y.MemberReference_Colon, configuration: r.configuration, content: t.colonExcerpt })),
...
var nr = (function (n) {
    ...
    function e(t) {
        ...
        return (
            T.isParsedParameters(t)
                ? ((r._selectorExcerpt = new j({ configuration: r.configuration, excerptKind: y.MemberSelector, content: t.selectorExcerpt })),
                  ...
                  : e._likeLabelSelectorRegExp.test(r._selector)
                    ...
                    : re.isSystemSelector(r._selector)
                      ...
                      : e._likeSystemSelectorRegExp.test(r._selector)
                        ? (r._errorMessage = 'The selector '.concat(JSON.stringify(r._selector)) + ' is not a recognized TSDoc system selector name')
...
var Za = (function () {
    ...
    rr = (function (n) {
        ...
        return (
            ...
            (e.prototype.onGetChildNodes = function () {
                return [this._leftBracketExcerpt, this._spacingAfterLeftBracketExcerpt, this._symbolReference, this._rightBracketExcerpt];
            }),
            e
        );
    })(T);
        ...
        function e(t) {
            ...
            return (
                ...
                T.isParsedParameters(t) &&
                    ...
                    t.hyphenExcerpt &&
                        (r._hyphenExcerpt = new j({ configuration: r.configuration, excerptKind: y.ParamBlock_Hyphen, content: t.hyphenExcerpt })),
...
var ts = (function () {
    ...
    Ve = (function (n) {
        ...
        function e(t) {
            var r = n.call(this, t) || this;
            if (T.isParsedParameters(t)) r._textExcerpt = new j({ configuration: r.configuration, excerptKind: y.PlainText, content: t.textExcerpt });
            else {
                if (e._newlineCharacterRegExp.test(t.text)) throw new Error('The DocPlainText content must not contain newline characters');
                r._text = t.text;
            }
            return r;
        }
    ...
    ir = (function (n) {
        ...
        function e(t) {
            ...
            if (T.isParsedParameters(t)) {
                var i = t;
                r._softBreakExcerpt = new j({ configuration: r.configuration, excerptKind: y.SoftBreak, content: i.softBreakExcerpt });
            }
            return r;
        }
        return (
...
var ze = (function () {
    ...
    return (
        ...
        (n.prototype.getDebugDump = function (e, t) {
            return this.buffer.substring(0, this.pos) + e + this.buffer.substring(this.pos, this.end) + t + this.buffer.substring(this.end);
        }),
...
`
        ...
        (n.prototype._validateBounds = function () {
            ...
            if (this.pos > this.buffer.length) throw new Error('TextRange.pos cannot exceed the associated text buffer length');
            if (this.end > this.buffer.length) throw new Error('TextRange.end cannot exceed the associated text buffer length');
        }),
        (n.empty = new n('', 0, 0)),
        n
    );
...
var _n = (function () {
    ...
    return (
        ...
        Object.defineProperty(n.prototype, 'text', {
            get: function () {
                return (this._text === void 0 && (this._text = n._formatMessageText(this.unformattedText, this.textRange)), this._text);
            },
            enumerable: !1,
            configurable: !0,
        }),
...
var Hr = (function () {
    ...
    return (
        ...
        (n.prototype.addMessageForTokenSequence = function (e, t, r, i) {
            this.addMessage(new _n({ messageId: e, messageText: t, textRange: r.getContainingTextRange(), tokenSequence: r, docNode: i }));
        }),
        (n.prototype.addMessageForDocErrorText = function (e) {
            var t;
            (e.textExcerpt ? (t = e.textExcerpt) : (t = e.errorLocation),
                this.addMessage(
                    new _n({ messageId: e.messageId, messageText: e.errorMessage, textRange: t.getContainingTextRange(), tokenSequence: t, docNode: e }),
                ));
        }),
        n
    );
...
var yt = (function () {
    function n(e) {
        ((this.parserContext = e.parserContext), (this._startIndex = e.startIndex), (this._endIndex = e.endIndex), this._validateBounds());
    }
    return (
        ...
        (n.prototype._validateBounds = function () {
            ...
            if (this.endIndex < this.startIndex) throw new Error('TokenSequence.endIndex cannot be smaller than TokenSequence.startIndex');
            if (this.startIndex > this.parserContext.tokens.length) throw new Error('TokenSequence.startIndex cannot exceed the associated token array');
            if (this.endIndex > this.parserContext.tokens.length) throw new Error('TokenSequence.endIndex cannot exceed the associated token array');
        }),
        n
    );
})();
...
var ro = (function () {
    ...
    return (
        (n.extract = function (e) {
            for (var t = e.sourceRange, r = t.buffer, i = 0, o = 0, a = 0, l = 0, c = t.pos, d = pe.BeginComment1, m = []; d !== pe.Done; ) {
                if (c >= t.end)
                    switch (d) {
                        case pe.BeginComment1:
                        case pe.BeginComment2:
                            return (e.log.addMessageForTextRange(v.CommentNotFound, 'Expecting a "/**" comment', t), !1);
                        default:
                            return (e.log.addMessageForTextRange(v.CommentMissingClosingDelimiter, 'Unexpected end of input', t), !1);
                    }
                var _ = r[c],
                    w = c;
                ++c;
                ...
                switch (d) {
                    case pe.BeginComment1:
                        if (_ === '/' && b === '*') ((i = w), ++c, (d = pe.BeginComment2));
                            ...
                            return (e.log.addMessageForTextRange(v.CommentOpeningDelimiterSyntax, 'Expecting a leading "/**"', t.getNewRange(w, w + 1)), !1);
                        break;
                    case pe.BeginComment2:
                        if (_ === '*') (b === ' ' && ++c, (a = c), (l = c), (d = pe.CollectingFirstLine));
                        else return (e.log.addMessageForTextRange(v.CommentOpeningDelimiterSyntax, 'Expecting a leading "/**"', t.getNewRange(w, w + 1)), !1);
                        break;
                    ...
                    case pe.CollectingLine:
                        ...
                        `
`
                            ? ((d !== pe.CollectingFirstLine || l > a) && m.push(t.getNewRange(a, l)), (a = c), (l = c), (d = pe.AdvancingLine))
                            : _ === '*' && b === '/'
...
var xn = (function () {
    ...
    return (
        (n.readTokens = function (e) {
            ...
            return (r ? t.push(new Nt(u.EndOfInput, r.getNewRange(r.end, r.end), r)) : t.push(new Nt(u.EndOfInput, ze.empty, ze.empty)), t);
        }),
        ...
        (n._pushTokensForLine = function (e, t) {
            for (var r = t.buffer, i = t.end, o = t.pos, a = void 0, l = o; o < i; ) {
                var c = r.charCodeAt(o),
                    d = n._charCodeMap[c];
                (d === void 0 && (d = u.Other),
                    (a !== void 0 && d === a && n._isMultiCharacterToken(a)) || (a !== void 0 && e.push(new Nt(a, t.getNewRange(l, o), t)), (l = o), (a = d)),
                    ++o);
            }
            (a !== void 0 && e.push(new Nt(a, t.getNewRange(l, o), t)), e.push(new Nt(u.Newline, t.getNewRange(t.end, t.end), t)));
        }),
...
var Kr = (function () {
    function n(e, t) {
        if (((this._parserContext = e), (this.tokens = e.tokens), t)) {
            if (t.parserContext !== this._parserContext) throw new Error('The embeddedTokenSequence must use the same parser context');
    ...
    return (
        (n.prototype.extractAccumulatedSequence = function () {
            ...
            var e = new yt({ parserContext: this._parserContext, startIndex: this._accumulatedStartIndex, endIndex: this._currentIndex });
...
` + JSON.stringify(t),
        ...
        (n.prototype.peekTokenAfterKind = function () {
            return this._currentIndex + 1 >= this._readerEndIndex ? u.EndOfInput : this.tokens[this._currentIndex + 1].kind;
        }),
        (n.prototype.peekTokenAfterAfterKind = function () {
            return this._currentIndex + 2 >= this._readerEndIndex ? u.EndOfInput : this.tokens[this._currentIndex + 2].kind;
        }),
...
var io = (function () {
    function n(e) {
        ((this._parserContext = e), (this._configuration = e.configuration), (this._currentSection = e.docComment.summarySection));
    }
    return (
                ...
                switch (e.peekTokenKind()) {
                    ...
                    case u.Newline:
                        (this._pushAccumulatedPlainText(e),
                            e.readToken(),
                            this._pushNode(new ir({ parsed: !0, configuration: this._configuration, softBreakExcerpt: e.extractAccumulatedSequence() })));
                        break;
                    case u.Backslash:
                    ...
                    case u.LessThan:
                        (this._pushAccumulatedPlainText(e),
                            e.peekTokenAfterKind() === u.Slash ? this._pushNode(this._parseHtmlEndTag(e)) : this._pushNode(this._parseHtmlStartTag(e)));
                        break;
                    case u.GreaterThan:
                        (this._pushAccumulatedPlainText(e),
                            this._pushNode(
            ...
            (e.deprecatedBlock &&
                (lr.hasAnyTextContent(e.deprecatedBlock) ||
                    this._parserContext.log.addMessageForTokenSequence(
                        ...
                        'The '.concat(e.deprecatedBlock.blockTag.tagName, ' block must include a deprecation message,') +
                ...
                a !== r
                    ? r
                        ? this._parserContext.log.addMessageForTokenSequence(
                              ...
                              'The TSDoc tag "'.concat(t, '" is not an inline tag; it must not be enclosed in "{ }" braces'),
                              i,
                              o,
                          )
                        : this._parserContext.log.addMessageForTokenSequence(
        ...
        (n.prototype._pushAccumulatedPlainText = function (e) {
            e.isAccumulatedSequenceEmpty() ||
                this._pushNode(new Ve({ parsed: !0, configuration: this._configuration, textExcerpt: e.extractAccumulatedSequence() }));
        }),
        ...
        (n.prototype._tryParseUnsupportedJSDocType = function (e, t, r) {
            if ((e.assertAccumulatedSequenceIsEmpty(), !(e.peekTokenKind() !== u.LeftCurlyBracket || e.peekTokenAfterKind() === u.AtSign))) {
        ...
        (n.prototype._parseParamBlock = function (e, t, r) {
            ...
            if (m !== void 0) {
                ...
                return (this._parserContext.log.addMessageForTokenSequence(v.ParamTagWithInvalidName, w, t.getTokenSequence(), t), _);
            }
            ...
            if (l) {
                ...
                (S && (k = t.getTokenSequence().getNewSequence(l.startIndex, S.endIndex)),
                    this._parserContext.log.addMessageForTokenSequence(
                        ...
                        'The ' + r + " should not include a JSDoc-style optional name; it must not be enclosed in '[ ]' brackets.",
                        k,
                        t,
                    ));
            }
        ...
        (n.prototype._parseBackslashEscape = function (e) {
            ...
            if ((e.readToken(), e.peekTokenKind() === u.EndOfInput))
                return this._backtrackAndCreateError(e, t, v.UnnecessaryBackslash, 'A backslash must precede another character that is being escaped');
            var r = e.readToken();
            if (!xn.isPunctuation(r.kind))
                return this._backtrackAndCreateError(e, t, v.UnnecessaryBackslash, 'A backslash can only be used to escape a punctuation character');
        ...
        (n.prototype._parseBlockTag = function (e) {
            e.assertAccumulatedSequenceIsEmpty();
            var t = e.createMarker();
            if (e.peekTokenKind() !== u.AtSign) return this._backtrackAndCreateError(e, t, v.MissingTag, 'Expecting a TSDoc tag starting with "@"');
            ...
            return new Un({ parsed: !0, configuration: this._configuration, tagName: r, tagNameExcerpt: e.extractAccumulatedSequence() });
        }),
        (n.prototype._parseInlineTag = function (e) {
            e.assertAccumulatedSequenceIsEmpty();
            var t = e.createMarker();
            if (e.peekTokenKind() !== u.LeftCurlyBracket) return this._backtrackAndCreateError(e, t, v.MissingTag, 'Expecting a TSDoc tag starting with "{"');
            e.readToken();
            var r = e.extractAccumulatedSequence(),
                i = e.createMarker();
            if (e.peekTokenKind() !== u.AtSign) return this._backtrackAndCreateError(e, t, v.MalformedInlineTag, 'Expecting a TSDoc tag starting with "{@"');
            for (var o = e.readToken().toString(); e.peekTokenKind() === u.AsciiWord; ) o += e.readToken().toString();
            if (o === '@') {
                var a = this._createFailureForTokensSince(e, v.MalformedInlineTag, 'Expecting a TSDoc inline tag name after the "{@" characters', i);
            ...
            if (c === void 0 && e.peekTokenKind() !== u.RightCurlyBracket) {
                var d = e.peekToken().range.toString()[0],
                    a = this._createFailureForToken(
                        ...
                        'The character '.concat(JSON.stringify(d), ' cannot appear after the TSDoc tag name; expecting a space'),
                    );
                return this._backtrackAndCreateErrorRangeForFailure(e, t, i, '', a);
            }
            for (var m = !1; !m; )
                switch (e.peekTokenKind()) {
                    ...
                    case u.Backslash:
                        if ((e.readToken(), !xn.isPunctuation(e.peekTokenKind()))) {
                            var a = this._createFailureForToken(e, v.UnnecessaryBackslash, 'A backslash can only be used to escape a punctuation character');
                            return this._backtrackAndCreateErrorRangeForFailure(e, t, i, 'Error reading inline TSDoc tag: ', a);
                        }
                        e.readToken();
                        break;
                    case u.LeftCurlyBracket: {
        ...
        (n.prototype._parseInheritDocTag = function (e, t) {
            ...
            if (t.peekTokenKind() !== u.EndOfInput) {
                if (((i.declarationReference = this._parseDeclarationReference(t, e.tagNameExcerpt, r)), !i.declarationReference)) return r;
                if (t.peekTokenKind() !== u.EndOfInput)
                    return (
                        t.readToken(),
                        this._parserContext.log.addMessageForTokenSequence(
        ...
        (n.prototype._parseLinkTag = function (e, t) {
            ...
            if (!e.tagContentExcerpt)
                return (this._parserContext.log.addMessageForTokenSequence(v.LinkTagEmpty, 'The @link tag content is missing', i.tagNameExcerpt, r), r);
            for (var o = t.peekTokenKind() === u.Slash && t.peekTokenAfterKind() === u.Slash, a = t.createMarker(), l = o; !l; )
                switch (t.peekTokenKind()) {
                    ...
                    case u.Plus:
                        ...
                        break;
                    case u.Colon:
                        (t.readToken(), (o = t.peekTokenKind() === u.Slash && t.peekTokenAfterKind() === u.Slash), (l = !0));
                        break;
                    default:
                        l = !0;
                }
            ...
            if (t.peekTokenKind() === u.Pipe) {
                (t.readToken(), (i.pipeExcerpt = t.extractAccumulatedSequence()), (i.spacingAfterPipeExcerpt = this._tryReadSpacingAndNewlines(t)), (l = !1));
                for (var c = void 0; !l; )
                    switch (t.peekTokenKind()) {
                        case u.EndOfInput:
                            l = !0;
                        ...
                        case u.LeftCurlyBracket:
                            ...
                            return (
                                this._parserContext.log.addMessageForTokenSequence(
                                    ...
                                    'The "'.concat(d, '" character may not be used in the link text without escaping it'),
                                    t.extractAccumulatedSequence(),
                                    r,
                                ),
                                r
                ...
                m &&
                    (c === void 0
                        ...
                        : c >= m.endIndex
                          ? (i.linkTextExcerpt = m)
                          : ((i.linkTextExcerpt = m.getNewSequence(m.startIndex, c)), (i.spacingAfterLinkTextExcerpt = m.getNewSequence(c, m.endIndex))));
        ...
        (n.prototype._parseLinkTagUrlDestination = function (e, t, r, i) {
            ...
            return c
                ...
                : ((t.urlDestinationExcerpt = l), (t.spacingAfterDestinationExcerpt = this._tryReadSpacingAndNewlines(e)), !0);
        }),
        ...
        (n.prototype._parseDeclarationReference = function (e, t, r) {
            ...
            if (o) {
                if (e.peekTokenKind() !== u.Period) {
                    ...
                    if (!e.isAccumulatedSequenceEmpty()) {
                        ...
                        if (k) {
                            this._parserContext.log.addMessageForTokenSequence(v.ReferenceMalformedPackageName, k, d, r);
                            return;
                        }
                    }
                }
                ...
                if ((e.readToken(), (_ = e.extractAccumulatedSequence()), (w = this._tryReadSpacingAndNewlines(e)), d === void 0 && m === void 0)) {
                    this._parserContext.log.addMessageForTokenSequence(
            ...
            if (d === void 0 && m === void 0 && E.length === 0) {
                this._parserContext.log.addMessageForTokenSequence(v.MissingReference, 'Expecting a declaration reference', t, r);
                return;
            }
            return new Vn({
                parsed: !0,
        ...
        (n.prototype._parseMemberReference = function (e, t, r, i) {
            ...
            if (t) {
                ...
                (e.readToken(), (o.dotExcerpt = e.extractAccumulatedSequence()), (o.spacingAfterDotExcerpt = this._tryReadSpacingAndNewlines(e)));
            }
            if (
        ...
        (n.prototype._parseMemberSymbol = function (e, t) {
            ...
            if (!o) {
                this._parserContext.log.addMessageForTokenSequence(v.ReferenceSymbolSyntax, 'Missing declaration reference in symbol reference', r, t);
                return;
            }
            if (e.peekTokenKind() !== u.RightSquareBracket) {
                this._parserContext.log.addMessageForTokenSequence(v.ReferenceMissingRightBracket, 'Missing closing square bracket for symbol reference', r, t);
                return;
            }
            e.readToken();
        ...
        (n.prototype._parseMemberIdentifier = function (e, t, r) {
            ...
            if (e.peekTokenKind() === u.DoubleQuote) {
                ...
                if (e.isAccumulatedSequenceEmpty()) {
                    this._parserContext.log.addMessageForTokenSequence(v.ReferenceEmptyIdentifier, 'The quoted identifier cannot be empty', i, r);
                    return;
                }
                var a = e.extractAccumulatedSequence();
                return (
                    ...
                    new hn({ parsed: !0, configuration: this._configuration, leftQuoteExcerpt: i, identifierExcerpt: a, rightQuoteExcerpt: o })
                );
            } else {
                for (var l = !1; !l; )
                    switch (e.peekTokenKind()) {
                ...
                return new hn({ parsed: !0, configuration: this._configuration, leftQuoteExcerpt: i, identifierExcerpt: a, rightQuoteExcerpt: o });
            }
        }),
        (n.prototype._parseMemberSelector = function (e, t, r) {
            e.peekTokenKind() !== u.AsciiWord &&
                this._parserContext.log.addMessageForTokenSequence(v.ReferenceMissingLabel, 'Expecting a selector label after the colon', t, r);
            var i = e.readToken().toString(),
                o = e.extractAccumulatedSequence(),
                a = new nr({ parsed: !0, configuration: this._configuration, selectorExcerpt: o, selector: i });
            if (a.errorMessage) {
        ...
        (n.prototype._parseHtmlStartTag = function (e) {
            ...
            for (var a = this._tryReadSpacingAndNewlines(e), l = []; e.peekTokenKind() === u.AsciiWord; ) {
                ...
                if (yn(c)) return this._backtrackAndCreateErrorForFailure(e, t, 'The HTML element has an invalid attribute: ', c);
                l.push(c);
            }
            e.assertAccumulatedSequenceIsEmpty();
            ...
            if ((e.peekTokenKind() === u.Slash && (e.readToken(), (m = !0)), e.peekTokenKind() !== u.GreaterThan)) {
                var _ = this._createFailureForTokensSince(e, v.HtmlTagMissingGreaterThan, 'Expecting an attribute or ">" or "/>"', d);
        ...
        (n.prototype._parseHtmlAttribute = function (e) {
            ...
            if (e.peekTokenKind() !== u.Equals) return this._createFailureForToken(e, v.HtmlTagMissingEquals, 'Expecting "=" after HTML attribute name');
            e.readToken();
            var i = e.extractAccumulatedSequence(),
                o = this._tryReadSpacingAndNewlines(e),
        ...
        (n.prototype._parseHtmlString = function (e) {
            ...
            for (var i = ''; ; ) {
                ...
                if (o === u.EndOfInput || o === u.Newline)
                    return this._createFailureForToken(e, v.HtmlStringMissingQuote, 'The HTML string is missing its closing quote', t);
                i += e.readToken().toString();
            }
            return e.peekTokenKind() === u.AsciiWord
                ? this._createFailureForToken(e, v.TextAfterHtmlString, 'The next character after a closing quote must be spacing or punctuation')
                : i;
        }),
        (n.prototype._parseHtmlEndTag = function (e) {
            ...
            var t = e.createMarker(),
                r = e.peekToken();
            if (r.kind !== u.LessThan) return this._backtrackAndCreateError(e, t, v.MissingHtmlEndTag, 'Expecting an HTML tag starting with "</"');
            e.readToken();
            var i = e.peekToken();
            if (i.kind !== u.Slash) return this._backtrackAndCreateError(e, t, v.MissingHtmlEndTag, 'Expecting an HTML tag starting with "</"');
            e.readToken();
            var o = e.extractAccumulatedSequence(),
                a = this._parseHtmlName(e);
            if (yn(a)) return this._backtrackAndCreateErrorForFailure(e, t, 'Expecting an HTML element name: ', a);
            var l = this._tryReadSpacingAndNewlines(e);
            if (e.peekTokenKind() !== u.GreaterThan) {
                var c = this._createFailureForToken(e, v.HtmlTagMissingGreaterThan, 'Expecting a closing ">" for the HTML tag');
        ...
        (n.prototype._parseHtmlName = function (e) {
            var t = e.createMarker();
            if (e.peekTokenKind() === u.Spacing) return this._createFailureForTokensSince(e, v.MalformedHtmlName, 'A space is not allowed here', t);
            for (var r = !1; !r; )
                switch (e.peekTokenKind()) {
                    case u.Hyphen:
                    case u.Period:
            ...
            return a
                ...
                : this._configuration.validation.reportUnsupportedHtmlElements && !this._configuration.isHtmlElementSupported(o)
                  ? this._createFailureForToken(
                        e,
                        v.UnsupportedHtmlElementName,
                        'The HTML element name '.concat(JSON.stringify(o), ' is not defined by your TSDoc configuration'),
                        t,
                    )
                  : i;
        }),
        (n.prototype._parseFencedCode = function (e) {
            ...
            var i = '';
            if (((i += e.readToken()), (i += e.readToken()), (i += e.readToken()), i !== '```')) throw new Error('Expecting three backticks');
            ...
            for (var a = e.tryExtractAccumulatedSequence(), l = !1, c = void 0; !l; )
                switch (e.peekTokenKind()) {
                    case u.Spacing:
                    case u.Newline:
                        (c === void 0 && (c = e.createMarker()), e.peekTokenKind() === u.Newline && (l = !0), e.readToken());
                        break;
                    case u.Backtick:
                        var d = this._createFailureForToken(e, v.CodeFenceSpecifierSyntax, 'The language specifier cannot contain backtick characters');
                        return this._backtrackAndCreateErrorRangeForFailure(e, t, r, 'Error parsing code fence: ', d);
                    case u.EndOfInput:
                        var m = this._createFailureForToken(e, v.CodeFenceMissingDelimiter, 'Missing closing delimiter');
            ...
            for (var E; !l; )
                switch (e.peekTokenKind()) {
                    case u.EndOfInput:
                        ...
                        return this._backtrackAndCreateErrorRangeForFailure(e, t, r, 'Error parsing code fence: ', m);
                    case u.Newline:
                        for (E = e.readToken(), S = e.createMarker(); e.peekTokenKind() === u.Spacing; ) E = e.readToken();
                        if (
        ...
        (n.prototype._parseCodeSpan = function (e) {
            e.assertAccumulatedSequenceIsEmpty();
            var t = e.createMarker();
            if (e.peekTokenKind() !== u.Backtick) throw new Error('Expecting a code span starting with a backtick character "`"');
            e.readToken();
            for (var r = e.extractAccumulatedSequence(), i = void 0, o = void 0; ; ) {
                ...
                if (a === u.EndOfInput || a === u.Newline)
                    return this._backtrackAndCreateError(e, t, v.CodeSpanMissingDelimiter, 'The code span is missing its closing backtick');
                e.readToken();
            }
            return new Gn({ parsed: !0, configuration: this._configuration, openingDelimiterExcerpt: r, codeExcerpt: i, closingDelimiterExcerpt: o });
        }),
        ...
        (n.prototype._createError = function (e, t, r) {
            e.readToken();
            var i = e.extractAccumulatedSequence(),
                o = new Pt({ parsed: !0, configuration: this._configuration, textExcerpt: i, messageId: t, errorMessage: r, errorLocation: i });
        ...
        (n.prototype._backtrackAndCreateErrorRange = function (e, t, r, i, o) {
            ...
            var a = e.extractAccumulatedSequence(),
                l = new Pt({ parsed: !0, configuration: this._configuration, textExcerpt: a, messageId: i, errorMessage: o, errorLocation: a });
...
var oo = (function () {
    ...
    return (
        ...
        (n._splitParagraph = function (e, t) {
            ...
            var o;
            (function (w) {
                ((w[(w.Start = 0)] = 'Start'), (w[(w.AwaitingTrailer = 1)] = 'AwaitingTrailer'), (w[(w.ReadingTrailer = 2)] = 'ReadingTrailer'));
            })(o || (o = {}));
...
function is(n, e) {
    let r = new Rr().parseString(e),
        i = new Yr(n);
    return ((i.description = os(r.docComment.summarySection)), (i.returns = as(r.docComment.returnsBlock)), (i.arguments = ss(r.docComment.params)), i);
}
function os(n) {
    try {
...
function vn(n) {
    ...
    return (t.frontmatter && (e = (0, Te.parseYaml)(t.frontmatter)), { frontmatter: e, content: n.slice(t.contentStart) });
}
...
var go = { name: 'applyStyles', enabled: !0, phase: 'write', fn: As, effect: _s, requires: ['computeStyles'] };
function ge(n) {
    return n.split('-')[0];
}
var qe = Math.max,
...
function Oe(n, e, t) {
    ...
    var r = n.getBoundingClientRect(),
        i = 1,
        o = 1;
    e && fe(n) && ((i = (n.offsetWidth > 0 && ut(r.width) / n.offsetWidth) || 1), (o = (n.offsetHeight > 0 && ut(r.height) / n.offsetHeight) || 1));
...
function Ft(n) {
    var e = Oe(n),
        ...
        r = n.offsetHeight;
    return (
        Math.abs(e.width - t) <= 1 && (t = e.width), Math.abs(e.height - r) <= 1 && (r = e.height), { x: n.offsetLeft, y: n.offsetTop, width: t, height: r }
    );
}
function bn(n, e) {
...
function Le(n) {
    ...
    return t && (me(t) === 'html' || (me(t) === 'body' && we(t).position === 'static')) ? e : t || xs(n) || e;
}
function qt(n) {
...
var ys = function (e, t) {
    return ((e = typeof e == 'function' ? e(Object.assign({}, t.rects, { placement: t.placement })) : e), Tn(typeof e != 'number' ? e : kn(e, wt)));
};
function js(n) {
    var e,
        t = n.state,
...
var _o = { name: 'arrow', enabled: !0, phase: 'main', fn: js, effect: vs, requires: ['popperOffsets'], requiresIfExists: ['preventOverflow'] };
function Be(n) {
    return n.split('-')[1];
}
...
function xo(n) {
    ...
    if (d) {
        var F = Le(t),
            ...
            te = 'clientWidth';
        if (
            (F === Z(t) && ((F = Ae(t)), we(F).position !== 'static' && l === 'absolute' && ((J = 'scrollHeight'), (te = 'scrollWidth'))),
            (F = F),
            i === ie || ((i === ae || i === ce) && o === Bt))
        ) {
            D = ue;
    ...
    if (((b = C.x), (k = C.y), c)) {
        ...
        return Object.assign(
            ...
            (f[D] = $ ? '0' : ''),
            (f[K] = O ? '0' : ''),
            (f.transform = (H.devicePixelRatio || 1) <= 1 ? 'translate(' + b + 'px, ' + k + 'px)' : 'translate3d(' + b + 'px, ' + k + 'px, 0)'),
            f),
        );
    }
    return Object.assign({}, h, ((e = {}), (e[D] = $ ? k + 'px' : ''), (e[K] = O ? b + 'px' : ''), (e.transform = ''), e));
}
function Es(n) {
    var e = n.state,
        t = n.options,
    ...
    (e.modifiersData.popperOffsets != null &&
        (e.styles.popper = Object.assign(
            {},
            e.styles.popper,
            xo(Object.assign({}, d, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: a, roundOffsets: c })),
        )),
        e.modifiersData.arrow != null &&
            (e.styles.arrow = Object.assign(
                {},
                e.styles.arrow,
                xo(Object.assign({}, d, { offsets: e.modifiersData.arrow, position: 'absolute', adaptive: !1, roundOffsets: c })),
            )),
...
var jo = { name: 'eventListeners', enabled: !0, phase: 'write', fn: function () {}, effect: Ts, data: {} };
...
function Jr(n) {
    var e,
        ...
        l = -r.scrollLeft + $t(n),
        c = -r.scrollTop;
    return (we(i || t).direction === 'rtl' && (l += qe(t.clientWidth, i ? i.clientWidth : 0) - o), { width: o, height: a, x: l, y: c });
}
function Kt(n) {
    var e = we(n),
        t = e.overflow,
...
function Ar(n) {
    return ['html', 'body', '#document'].indexOf(me(n)) >= 0 ? n.ownerDocument.body : fe(n) && Kt(n) ? n : Ar(ft(n));
}
function bt(n, e) {
    var t;
    e === void 0 && (e = []);
...
function Qr(n, e, t, r) {
    var i = e === 'clippingParents' ? Ds(n) : [].concat(e),
        ...
        l = o.reduce(
            function (c, d) {
                var m = vo(n, d, r);
                return ((c.top = qe(m.top, c.top)), (c.right = It(m.right, c.right)), (c.bottom = It(m.bottom, c.bottom)), (c.left = qe(m.left, c.left)), c);
            },
            vo(n, a, r),
        );
...
function He(n, e) {
    ...
    var t = e,
        ...
        ne = w === Zt ? te : F,
        Q = { top: H.top - ne.top + O.top, bottom: ne.bottom - H.bottom + O.bottom, left: H.left - ne.left + O.left, right: ne.right - H.right + O.right },
        ...
        for (
            var i = t.mainAxis,
                ...
                D = [E].concat(K).reduce(function (B, N) {
                    return B.concat(
                        ge(N) === fr ? Xr(e, { placement: N, boundary: m, rootBoundary: _, padding: d, flipVariations: S, allowedAutoPlacements: k }) : N,
                    );
                }, []),
                H = e.rects.reference,
                F = e.rects.popper,
...
var wo = { name: 'flip', enabled: !0, phase: 'main', fn: Ns, requiresIfExists: ['offset'], data: { _skip: !1 } };
function bo(n, e, t) {
    return (
        t === void 0 && (t = { x: 0, y: 0 }),
        { top: n.top - e.height - t.y, right: n.right - e.width + t.x, bottom: n.bottom - e.height + t.y, left: n.left - e.width - t.x }
    );
}
function Eo(n) {
...
function Ms(n) {
    var e = n.state,
        ...
        m = Eo(c),
        _ = Eo(d);
    ((e.modifiersData[t] = { referenceClippingOffsets: c, popperEscapeOffsets: d, isReferenceHidden: m, hasPopperEscaped: _ }),
        (e.attributes.popper = Object.assign({}, e.attributes.popper, { 'data-popper-reference-hidden': m, 'data-popper-escaped': _ })));
}
var To = { name: 'hide', enabled: !0, phase: 'main', requiresIfExists: ['preventOverflow'], fn: Ms };
function Os(n, e, t) {
    var r = ge(n),
...
function Bs(n) {
    var e = n.state,
        ...
        c = l.x,
        d = l.y;
    (e.modifiersData.popperOffsets != null && ((e.modifiersData.popperOffsets.x += c), (e.modifiersData.popperOffsets.y += d)), (e.modifiersData[r] = a));
}
var ko = { name: 'offset', enabled: !0, phase: 'main', requires: ['popperOffsets'], fn: Bs };
function Is(n) {
    var e = n.state,
        t = n.name;
    e.modifiersData[t] = Sn({ reference: e.rects.reference, element: e.rects.popper, strategy: 'absolute', placement: e.placement });
}
    ...
    if (!!F) {
        if (o) {
            var f,
                ...
                N = e.modifiersData['arrow#persistent'] ? e.modifiersData['arrow#persistent'].padding : En(),
                q = N[Ie],
                ee = N[Ee],
                tt = Lt(0, J[_e], B[_e]),
...
var Co = { name: 'preventOverflow', enabled: !0, phase: 'main', fn: Fs, requiresIfExists: ['offset'] };
function ei(n) {
...
function ni(n, e, t) {
    ...
    return (
        (r || (!r && !t)) &&
            ((me(e) !== 'body' || Kt(o)) && (l = ti(e)), fe(e) ? ((c = Oe(e, !0)), (c.x += e.clientLeft), (c.y += e.clientTop)) : o && (c.x = $t(o))),
...
function oi(n) {
    var e = n.reduce(function (t, r) {
        var i = t[r.name];
        return (
            (t[r.name] = i ? Object.assign({}, i, r, { options: Object.assign({}, i.options, r.options), data: Object.assign({}, i.data, r.data) }) : r), t
        );
    }, {});
            ...
            b = {
                ...
                setOptions: function (O) {
                    ...
                    (k(),
                        ...
                        (m.scrollParents = { reference: Me(l) ? bt(l) : l.contextElement ? bt(l.contextElement) : [], popper: bt(c) }));
                ...
                forceUpdate: function () {
                    if (!w) {
                        var O = m.elements,
                            ...
                            K = O.popper;
                        if (!!Po($, K)) {
                            ((m.rects = { reference: ni($, Le(K), m.options.strategy === 'fixed'), popper: Ft(K) }),
                                (m.reset = !1),
                            ...
                            for (var D = 0; D < m.orderedModifiers.length; D++) {
                                ...
                                var H = m.orderedModifiers[D],
                                    ...
                                    te = J === void 0 ? {} : J,
                                    ne = H.name;
                                typeof F == 'function' && (m = F({ state: m, options: te, name: ne, instance: b }) || m);
                            }
                        }
                    }
                },
...
var $s = (n, e) => ((n % e) + e) % e,
    Oo = class {
        ...
        setSelectedItem(e, t) {
            ...
            (i?.removeClass('is-selected'), o?.addClass('is-selected'), (this.selectedItem = r), t && o.scrollIntoView(!1));
        }
    },
    Cn = class {
        constructor(e, t) {
            ((this.app = e), (this.inputEl = t), (this.scope = new Mo.Scope()), (this.suggestEl = createDiv('suggestion-container')));
        ...
        onInputChanged() {
            ...
            t.length > 0 ? (this.suggest.setSuggestions(t), this.open(this.app.dom.appContainerEl, this.inputEl)) : this.close();
        }
        open(e, t) {
        ...
        close() {
            (this.app.keymap.popScope(this.scope), this.suggest.setSuggestions([]), this.popper && this.popper.destroy(), this.suggestEl.detach());
        }
    };
var $e;
(function (t) {
    ...
    si = class extends L.PluginSettingTab {
        ...
        display() {
            (this.containerEl.empty(),
                ...
                this.plugin.settings.trigger_on_file_creation && (this.add_folder_templates_setting(), this.add_file_templates_setting()),
                ...
                .addSearch((e) => {
                    (new Dn(this.app, e.inputEl),
                        e
                            ...
                            .onChange((t) => {
                                ((t = t.trim()), (t = t.replace(/\/$/, '')), (this.plugin.settings.templates_folder = t), this.plugin.save_settings());
                            }),
            ...
            (e.append('Template hotkeys allows you to bind a template to a hotkey.'),
                    ...
                    new L.Setting(this.containerEl)
                            ...
                            (new on(o.inputEl, this.plugin, $e.TemplateFiles),
                                o
                                    ...
                                    .onChange((a) => {
                                        ...
                                        (this.plugin.command_handler.add_template_hotkey(this.plugin.settings.enabled_templates_hotkeys[r], a),
                        ...
                        .addExtraButton((o) => {
                            o.setIcon('up-chevron-glyph')
                                .setTooltip('Move up')
                                .onClick(() => {
                                    (Ot(this.plugin.settings.enabled_templates_hotkeys, r, r - 1), this.plugin.save_settings(), this.display());
                                });
                        })
                        .addExtraButton((o) => {
                        ...
                        .addExtraButton((o) => {
                            o.setIcon('cross')
                                .setTooltip('Delete')
                                .onClick(() => {
                                    (this.plugin.command_handler.remove_template_hotkey(this.plugin.settings.enabled_templates_hotkeys[r]),
                ...
                new L.Setting(this.containerEl).addButton((t) => {
                    t.setButtonText('Add new hotkey for template')
                        .setCta()
                        .onClick(() => {
                            (this.plugin.settings.enabled_templates_hotkeys.push(''), this.plugin.save_settings(), this.display());
                        });
                }));
        }
                ...
                !!this.plugin.settings.enable_folder_templates &&
                        ...
                        new L.Setting(this.containerEl)
                                ...
                                (new Dn(this.app, a.inputEl),
                                    a
                                        ...
                                        .onChange((l) => {
                                            ...
                                            ((this.plugin.settings.folder_templates[i].folder = l), this.plugin.save_settings());
                                        }),
                            ...
                            .addSearch((a) => {
                                (new on(a.inputEl, this.plugin, $e.TemplateFiles),
                                    a
                                        ...
                                        .setValue(r.template)
                                        .onChange((l) => {
                                            ((this.plugin.settings.folder_templates[i].template = l), this.plugin.save_settings());
                                        }),
                                    a.containerEl.addClass('templater_search'));
                            })
                            .addExtraButton((a) => {
                                a.setIcon('up-chevron-glyph')
                                    .setTooltip('Move up')
                                    .onClick(() => {
                                        (Ot(this.plugin.settings.folder_templates, i, i - 1), this.plugin.save_settings(), this.display());
                                    });
                            })
                            .addExtraButton((a) => {
                            ...
                            .addExtraButton((a) => {
                                a.setIcon('cross')
                                    .setTooltip('Delete')
                                    .onClick(() => {
                                        (this.plugin.settings.folder_templates.splice(i, 1), this.plugin.save_settings(), this.display());
                                    });
                            })
                            .infoEl.remove();
                    }),
                    new L.Setting(this.containerEl).addButton((r) => {
                        r.setButtonText('Add new folder template')
                            ...
                            .setCta()
                            .onClick(() => {
                                (this.plugin.settings.folder_templates.push({ folder: '', template: '' }), this.plugin.save_settings(), this.display());
                            });
                    })));
        }
                ...
                !!this.plugin.settings.enable_file_templates &&
                        ...
                        new L.Setting(this.containerEl)
                            ...
                            .addSearch((a) => {
                                (new on(a.inputEl, this.plugin, $e.TemplateFiles),
                                    a
                                        ...
                                        .setValue(r.template)
                                        .onChange((l) => {
                                            ((this.plugin.settings.file_templates[i].template = l), this.plugin.save_settings());
                                        }),
                                    a.containerEl.addClass('templater_search'));
                            })
                            .addExtraButton((a) => {
                                a.setIcon('up-chevron-glyph')
                                    .setTooltip('Move up')
                                    .onClick(() => {
                                        (Ot(this.plugin.settings.file_templates, i, i - 1), this.plugin.save_settings(), this.display());
                                    });
                            })
                            .addExtraButton((a) => {
                                a.setIcon('down-chevron-glyph')
                            ...
                            .addExtraButton((a) => {
                                a.setIcon('cross')
                                    .setTooltip('Delete')
                                    .onClick(() => {
                                        (this.plugin.settings.file_templates.splice(i, 1), this.plugin.save_settings(), this.display());
                                    });
                            })
                            .infoEl.remove();
                    }),
                    new L.Setting(this.containerEl).addButton((r) => {
                        r.setButtonText('Add new file regex')
                            ...
                            .setCta()
                            .onClick(() => {
                                (this.plugin.settings.file_templates.push({ regex: '', template: '' }), this.plugin.save_settings(), this.display());
                            });
                    })));
        }
            ...
            (e.append(
                    ...
                    new L.Setting(this.containerEl)
                        ...
                        .addExtraButton((o) => {
                            o.setIcon('cross')
                                .setTooltip('Delete')
                                .onClick(() => {
                                    (this.plugin.settings.startup_templates.splice(r, 1), this.plugin.save_settings(), this.display());
                                });
                        })
                        .infoEl.remove();
                }),
                new L.Setting(this.containerEl).addButton((t) => {
                    t.setButtonText('Add new startup template')
                        .setCta()
                        .onClick(() => {
                            (this.plugin.settings.startup_templates.push(''), this.plugin.save_settings(), this.display());
                        });
                }));
        }
        add_user_script_functions_setting() {
            ...
            if (!this.plugin.settings.user_scripts_folder) t = 'No user scripts folder set';
                ...
                let r = Ce(() => Je(this.app, this.plugin.settings.user_scripts_folder), "User scripts folder doesn't exist");
                if (!r || r.length === 0) t = 'No user scripts detected';
                else {
                    let i = 0;
                    for (let o of r) o.extension === 'js' && (i++, e.append(e.createEl('li', { text: `tp.user.${o.basename}` })));
                ...
                new L.Setting(this.containerEl)
                    ...
                    .addToggle((t) => {
                        t.setValue(this.plugin.settings.enable_system_commands).onChange((r) => {
                            ((this.plugin.settings.enable_system_commands = r), this.plugin.save_settings(), this.display());
                        });
                    }),
                        ...
                        new L.Setting(this.containerEl)
                            .addExtraButton((d) => {
                                d.setIcon('cross')
                                    ...
                                    .onClick(() => {
                                        ...
                                        m > -1 && (this.plugin.settings.templates_pairs.splice(m, 1), this.plugin.save_settings(), this.display());
                                    });
                            })
                            .addText((d) => {
                                let m = d
                                    ...
                                    .onChange((_) => {
                                        ...
                                        w > -1 && ((this.plugin.settings.templates_pairs[w][0] = _), this.plugin.save_settings());
                                    });
                            ...
                            .addTextArea((d) => {
                                let m = d
                                    ...
                                    .onChange((_) => {
                                        let w = this.plugin.settings.templates_pairs.indexOf(o);
                                        w > -1 && ((this.plugin.settings.templates_pairs[w][1] = _), this.plugin.save_settings());
                                    });
                    ...
                    new L.Setting(this.containerEl)
                        .addButton((o) => {
                            o.setButtonText('Add new user function')
                                .setCta()
                                .onClick(() => {
                                    (this.plugin.settings.templates_pairs.push(['', '']), this.plugin.save_settings(), this.display());
                                });
                        })
                        .infoEl.remove(),
        ...
        add_donating_setting() {
            let e = new L.Setting(this.containerEl).setName('Donate').setDesc('If you like this Plugin, consider donating to support continued development.'),
                t = document.createElement('a');
            (t.setAttribute('href', 'https://github.com/sponsors/silentvoid13'), t.addClass('templater_donating'));
            let r = document.createElement('img');
            ((r.src = 'https://img.shields.io/static/v1?label=Sponsor&message=%E2%9D%A4&logo=GitHub&color=%23fe8e86'), t.appendChild(r));
            let i = document.createElement('a');
            (i.setAttribute('href', 'https://www.paypal.com/donate?hosted_button_id=U2SRGAFYXT32Q'), i.addClass('templater_donating'));
...
var ci = class extends _r.FuzzySuggestModal {
    ...
    getItemText(e) {
        let t = e.path;
        if (e.path.startsWith(this.plugin.settings.templates_folder) && (0, _r.normalizePath)(this.plugin.settings.templates_folder) != '/') {
...
var be = class {
    ...
    async generate_object(e) {
        return ((this.config = e), await this.create_dynamic_templates(), { ...this.static_object, ...Object.fromEntries(this.dynamic_functions) });
    }
};
var li = class extends be {
    ...
    generate_now() {
        return (e = 'YYYY-MM-DD', t, r, i) => {
            if (r && !(0, mt.moment)(r, i).isValid()) throw new P("Invalid reference date format, try specifying one with the argument 'reference_format'");
            let o;
            return (
                typeof t == 'string' ? (o = mt.moment.duration(t)) : typeof t == 'number' && (o = mt.moment.duration(t, 'days')),
...
var Ro = 10,
    pi = class extends be {
        ...
        generate_include() {
            return async (e) => {
                if (((this.include_depth += 1), this.include_depth > Ro)) throw ((this.include_depth -= 1), new P('Reached inclusion depth limit (max = 10)'));
                let t;
                if (e instanceof le.TFile) t = await this.plugin.app.vault.read(e);
                else {
                    let r;
                    if ((r = this.linkpath_regex.exec(e)) === null)
                        throw ((this.include_depth -= 1), new P('Invalid file format, provide an obsidian link between quotes.'));
                ...
                try {
                    let r = await this.plugin.templater.parser.parse_commands(t, this.plugin.templater.current_functions_object);
        ...
        generate_path() {
            return (e = !1) => {
                ...
                if (le.Platform.isMobile) {
                    ...
                    t = `${r}/${i}`;
                } else if (this.plugin.app.vault.adapter instanceof le.FileSystemAdapter) t = this.plugin.app.vault.adapter.getBasePath();
        ...
        generate_rename() {
            return async (e) => {
                ...
                let t = (0, le.normalizePath)(`${this.config.target_file.parent.path}/${e}.${this.config.target_file.extension}`);
...
var ui = class extends be {
    ...
    generate_daily_quote() {
        return async () => {
            try {
                let t = (await this.getRequest('https://raw.githubusercontent.com/Zachatoo/quotes-database/refs/heads/main/quotes.json')).json,
...
> \u2014 ${o}`;
    ...
    generate_random_picture() {
        return async (e, t, r = !1) => {
            try {
                let i = await this.getRequest(`https://templater-unsplash-2.fly.dev/${t ? '?q=' + t : ''}`).then((a) => a.json),
                    o = i.full;
                if (e && !r)
                    if (e.includes('x')) {
                        let [a, l] = e.split('x');
                ...
                return r ? `![photo by ${i.photog}(${i.photogUrl}) on Unsplash|${e}](${o})` : `![photo by ${i.photog}(${i.photogUrl}) on Unsplash](${o})`;
            } catch {
...
var Uo = X(require('obsidian')),
    gi = class extends Uo.FuzzySuggestModal {
        ...
        getItemText(e) {
            return this.text_items instanceof Function ? this.text_items(e) : this.text_items[this.items.indexOf(e)] || 'Undefined Text Item';
        }
        onChooseItem(e) {
            this.resolve(e);
        }
    ...
    hi = class extends De.Modal {
        constructor(e, t, r, i, o) {
            ...
            (l.inputEl.addClass('templater-multisuggester-input'),
                (this.suggester = new Go(e, l.inputEl, this.getItemText.bind(this), r, o).onSelect(this.onChooseItem.bind(this))));
...
var yi = class {
    constructor(e) {
        this.plugin = e;
        if (Pn.Platform.isMobile || !(this.plugin.app.vault.adapter instanceof Pn.FileSystemAdapter)) this.cwd = '';
        else {
...
var ji = class {
    ...
    async load_user_script_function(e, t) {
        ...
        if (typeof l == 'function') t.set(e.basename, l);
            ...
            if (!Object.values(l).every((d) => typeof d == 'function')) throw new P(`Exported object in "${e.path}" must contain only functions.`);
            t.set(e.basename, l);
...
var Rt = class {
        ...
        constructor(e, t, r, i, o, a, l) {
            let c = gt(e, M.__wbindgen_malloc, M.__wbindgen_realloc),
                ...
                b = Re,
                S = M.parserconfig_new(c, d, m, _, r.codePointAt(0), i.codePointAt(0), o.codePointAt(0), a.codePointAt(0), w, b);
            return Rt.__wrap(S);
        }
        get opening_tag() {
            try {
...
function Js(n, e) {}
function Qs(n, e) {
    return ((M = n.exports), (Vo.__wbindgen_wasm_module = e), (vr = new Int32Array()), (xr = new Uint8Array()), M);
}
async function Vo(n) {
    ...
    async end_templater_task(e) {
        (this.files_with_pending_templates.delete(e),
            this.files_with_pending_templates.size === 0 &&
                (this.plugin.app.workspace.trigger('templater:all-templates-executed'), await this.functions_generator.teardown()));
    }
    async create_new_note_from_template(e, t, r, i = !0) {
        ...
        let o = (e instanceof de.TFile && e.extension) || 'md',
            a = await Se(async () => {
                let m = t instanceof de.TFolder ? t.path : t,
                    _ = this.plugin.app.vault.getAvailablePath((0, de.normalizePath)(`${m ?? ''}/${r || 'Untitled'}`), o),
                    w = lo(_);
                return (
                    w && !this.plugin.app.vault.getAbstractFileByPathInsensitive(w) && (await this.plugin.app.vault.createFolder(w)),
        ...
        if (
            (e instanceof de.TFile
                ? ((c = this.create_running_config(e, a, 0)), (d = await Se(async () => this.read_and_parse_template(c), 'Template parsing error, aborting.')))
                : ((c = this.create_running_config(void 0, a, 0)), (d = await Se(async () => this.parse_template(c, e), 'Template parsing error, aborting.'))),
            d == null)
        ) {
            (await this.plugin.app.vault.delete(a), await this.end_templater_task(l));
            return;
        }
        if ((await this.plugin.app.vault.modify(a, d), this.plugin.app.workspace.trigger('templater:new-note-from-template', { file: a, content: d }), i)) {
...
`),
            ...
            if (c !== null) {
                ...
                if (d !== null) {
                    ...
                    if (!a) {
                        ...
                        ((l = await this.functions_generator.generate_object(_, Xe.USER_INTERNAL)), (this.current_functions_object = l));
                    }
                }
                for (; d != null; ) {
                    let m = d[1] + d[2],
                        _ = await Se(async () => await this.parser.parse_commands(m, l), `Command Parsing error in dynamic command '${m}'`);
                    if (_ == null) return;
                    let w = r.lastIndex - d[0].length,
                        b = r.lastIndex;
                    ((c = c.substring(0, w) + _ + c.substring(b)), (r.lastIndex += _.length - d[0].length), (d = r.exec(c)));
                }
                o.nodeValue = c;
            }
        }
    ...
    static async on_file_creation(e, t, r) {
        ...
        if (l == 0 && e.plugin.settings.enable_folder_templates) {
            ...
            let c = 1e5;
            r.stat.size <= c ? await e.overwrite_file_commands(r) : console.log(`Templater skipped parsing ${r.path} because file size exceeds ${c}`);
        }
    }
    async execute_startup_scripts() {
        for (let e of this.plugin.settings.startup_templates) {
            ...
            (await Se(async () => this.read_and_parse_template(i), 'Startup Template parsing error, aborting.'), await this.end_templater_task(r));
        }
    }
};
...
var br = class {
    ...
    setup() {
        (this.plugin.app.workspace.onLayoutReady(() => {
            if (this.settings.trigger_on_file_creation && this.plugin.app.vault.getConfig('openBehavior') === 'daily') {
    ...
    update_trigger_file_on_creation() {
        this.settings.trigger_on_file_creation
            ? ((this.trigger_on_file_creation_event = this.plugin.app.vault.on('create', (e) => cn.on_file_creation(this.templater, this.plugin.app, e))),
              this.plugin.registerEvent(this.trigger_on_file_creation_event))
            : this.trigger_on_file_creation_event &&
              (this.plugin.app.vault.offref(this.trigger_on_file_creation_event), (this.trigger_on_file_creation_event = void 0));
    }
    update_file_menu() {
...
var Si = class {
    ...
    add_template_hotkey(e, t) {
        if ((this.remove_template_hotkey(e), t)) {
            let r = this.plugin.settings.templates_folder ? this.plugin.settings.templates_folder.length + 1 : 0,
                i = t.slice(r, -3);
            (this.plugin.addCommand({
                id: t,
                name: `Insert ${i}`,
                icon: 'templater-icon',
                callback: () => {
                    let o = Ce(() => Mt(this.plugin.app, t), "Couldn't find the template file associated with this hotkey");
...
`,
    ...
    get_cursor_matches_and_positions(e) {
        ...
        for (let d of a) {
            let m = d.index - c;
            (l.push(this.get_editor_position_from_index(e, m)), (e = e.slice(0, m) + e.slice(m + d[0].length)), (c += d[0].length));
        }
...
var ec = {
        app: { name: 'app', description: 'This module exposes the app instance. Prefer to use this over the global app instance.' },
        user: { name: 'user', description: 'This module exposes custom made scripts, written by yourself within the script file folder location' },
        config: {
            name: 'config',
            ...
            functions: {
                now: {
                    ...
                    examples: [
                        ...
                        { name: "File's title date + 1 day (tomorrow)", example: '<% tp.date.now("YYYY-MM-DD", 1, tp.file.title, "YYYY-MM-DD") %>' },
                        { name: "File's title date - 1 day (yesterday)", example: '<% tp.date.now("YYYY-MM-DD", -1, tp.file.title, "YYYY-MM-DD") %>' },
                    ],
                },
                tomorrow: {
                    name: 'tomorrow',
                ...
                weekday: {
                    ...
                    examples: [
                        ...
                        { name: "File's title Monday", example: '<% tp.date.weekday("YYYY-MM-DD", 0, tp.file.title, "YYYY-MM-DD") %>' },
                        { name: "File's title previous Monday", example: '<% tp.date.weekday("YYYY-MM-DD", -7, tp.file.title, "YYYY-MM-DD") %>' },
                    ],
                },
            },
            momentjs: {
                examples: [
                    ...
                    { name: 'Get start of month from note title', example: '<% moment(tp.file.title, "YYYY-MM-DD").startOf("month").format("YYYY-MM-DD") %>' },
                    { name: 'Get end of month from note title', example: '<% moment(tp.file.title, "YYYY-MM-DD").endOf("month").format("YYYY-MM-DD") %>' },
                ],
            },
        },
        file: {
            ...
            functions: {
                ...
                create_new: {
                    ...
                    examples: [
                        { name: 'File creation', example: '<%* await tp.file.create_new("MyFileContent", "MyFilename") %>' },
                        { name: 'File creation with template', example: '<%* await tp.file.create_new(tp.file.find_tfile("MyTemplate"), "MyFilename") %>' },
                        { name: 'File creation and open created note', example: '<%* await tp.file.create_new("MyFileContent", "MyFilename", true) %>' },
                        {
                ...
                creation_date: {
                    ...
                    examples: [
                        ...
                        { name: 'File creation date with format', example: '<% tp.file.creation_date("dddd Do MMMM YYYY HH:mm") %>' },
                    ],
                },
                cursor: {
                    name: 'cursor',
...
`,
                ...
                exists: {
                    ...
                    args: [{ name: 'filepath', description: 'The full file path of the file we want to check existence for.' }],
                    examples: [
                        { name: 'File existence', example: '<% await tp.file.exists("MyFolder/MyFile.md") %>' },
                        { name: 'File existence of current file', example: '<% await tp.file.exists(tp.file.folder(true) + "/" + tp.file.title + ".md") %>' },
                    ],
                },
                find_tfile: {
                    name: 'find_tfile',
                    ...
                    args: [{ name: 'filename', description: 'The filename we want to search and resolve as a `TFile`.' }],
                ...
                folder: {
                    ...
                    examples: [
                        ...
                        { name: 'File folder with vault-absolute path (Path/To/Folder)', example: '<% tp.file.folder(true) %>' },
                    ],
                },
                include: {
                    name: 'include',
                    ...
                    examples: [
                        ...
                        { name: 'File include TFile', example: '<% await tp.file.include(tp.file.find_tfile("MyFile")) %>' },
                ...
                last_modified_date: {
                    ...
                    examples: [
                        ...
                        { name: 'File last modified date with format', example: '<% tp.file.last_modified_date("dddd Do MMMM YYYY HH:mm") %>' },
                    ],
                },
                move: {
                    name: 'move',
                ...
                path: {
                    ...
                    args: [{ name: 'relative', description: "If set to `true`, only retrieves the vault's relative path." }],
                    examples: [
                ...
                rename: {
                    ...
                    examples: [
                        ...
                        { name: 'File append a 2 to the file name', example: '<%* await tp.file.rename(tp.file.title + "2") %>' },
                    ],
                },
                selection: {
                    name: 'selection',
                ...
                title: {
                    ...
                    examples: [
                        ...
                        { name: 'Strip the Zettelkasten ID of title (if space separated)', example: '<% tp.file.title.split(" ")[1] %>' },
                    ],
                },
            },
        },
        frontmatter: { name: 'frontmatter', description: 'This modules exposes all the frontmatter variables of a file as variables.' },
        hooks: {
            name: 'hooks',
        ...
        obsidian: { name: 'obsidian', description: 'This module exposes all the functions and classes from the Obsidian API.' },
        system: {
            name: 'system',
            ...
            functions: {
                ...
                prompt: {
                    ...
                    args: [
                        ...
                        { name: 'throw_on_cancel', description: 'Throws an error if the prompt is canceled, instead of returning a `null` value.' },
                        { name: 'multiline', description: 'If set to `true`, the input field will be a multiline textarea. Defaults to `false`.' },
                    ],
                    examples: [
                        { name: 'Prompt', example: '<% await tp.system.prompt("Please enter a value") %>' },
                        { name: 'Prompt with default value', example: '<% await tp.system.prompt("What is your mood today?", "happy") %>' },
                        { name: 'Multiline prompt', example: '<% await tp.system.prompt("What is your mood today?", null, false, true) %>' },
                        {
...
selected value: <% value %>`,
                ...
                suggester: {
                    ...
                    args: [
                        ...
                        { name: 'items', description: 'Array containing the values of each item in the correct order.' },
                        { name: 'throw_on_cancel', description: 'Throws an error if the prompt is canceled, instead of returning a `null` value.' },
                    ...
                    examples: [
                        { name: 'Suggester', example: '<% await tp.system.suggester(["Happy", "Sad", "Confused"], ["Happy", "Sad", "Confused"]) %>' },
                        {
...
selected values: <% selectedValues %>`,
            ...
            functions: {
                ...
                random_picture: {
                    ...
                    args: [
                        ...
                        { name: 'include_size', description: 'Optional argument to include the specified size in the image link markdown. Defaults to false.' },
                    ],
                    examples: [
                        ...
                        { name: 'Random picture with size and query', example: '<% await tp.web.random_picture("200x200", "landscape,water") %>' },
                    ],
                },
                request: {
                    name: 'request',
                    ...
                    examples: [
                        { name: 'Simple request', example: '<% await tp.web.request("https://jsonplaceholder.typicode.com/todos/1") %>' },
                        { name: 'Request with path', example: '<% await tp.web.request("https://jsonplaceholder.typicode.com/todos", "0.title") %>' },
                    ],
                },
            },
        },
    ...
    Xo = { tp: ec };
var tc = ['app', 'config', 'date', 'file', 'frontmatter', 'hooks', 'obsidian', 'system', 'user', 'web'],
    nc = new Set(tc);
function Zo(n) {
...
var Ni = class {
    ...
    get_all_modules_documentation() {
        ...
        return (
            (!this.plugin.settings || !this.plugin.settings.user_scripts_folder) && (e = Object.values(e).filter((t) => t.name !== 'user')),
    ...
    async get_all_functions_documentation(e, t) {
        ...
        if (e === 'user') {
            ...
            let r = await Se(async () => {
                let i = Je(this.plugin.app, this.plugin.settings.user_scripts_folder).filter((a) => a.extension == 'js');
                          ...
                          o.extension !== 'js'
                              ...
                              : [
                                    ...i,
                                    {
                                        ...
                                        returns: o.returns,
                                        args: o.arguments.reduce((l, c) => ((l[c.name] = { name: c.name, description: c.description }), l), {}),
                                        example: '',
                                    },
                                ],
                      [],
        ...
        if (!!this.documentation.tp[e].functions) return Object.values(this.documentation.tp[e].functions).map((r) => ((r.queryKey = r.name), r));
    }
    get_app_functions_documentation(e, t) {
        ...
        for (let c in i) {
            let d = `${o}.${c}`,
                m = a ? `${a}.${c}` : c;
            l.push({ name: c, queryKey: m, definition: typeof i[c] == 'function' ? `${d}(${po(i[c])})` : d, description: '', returns: '', example: '' });
        }
        return l;
    }
...
var Mi = class extends ea.EditorSuggest {
    constructor(e) {
        ...
        ((this.documentation = new Ni(e)), (this.intellisense_render_setting = e.settings.intellisense_render));
    }
    onTrigger(e, t, r) {
...
(function (n) {
    ...
    (n.defineMode('javascript', function (e, t) {
        ...
        function O(s, p) {
            ...
            if (/\d/.test(A)) return (s.match(/^[\d_]*(?:n|(?:\.[\d_]*)?(?:[eE][+\-]?[\d_]+)?)?/), E('number', 'number'));
            if (A == '/')
                return s.eat('*')
                    ? ((p.tokenize = K), K(s, p))
                    : s.eat('/')
            ...
            if (_.test(A))
                return (
                    (A != '>' || !p.lexical || p.lexical.type != '>') &&
                        (s.eat('=') ? (A == '!' || A == '=') && s.eat('=') : /[<>*+\-|&?]/.test(A) && (s.eat(A), A == '>' && s.eat(A))),
            ...
            if (d.test(A)) {
                ...
                if (p.lastType != '.') {
                    ...
                    if (x == 'async' && s.match(/^(\s|\/\*([^*]|\*(?!\/))*?\*\/)*[\[\(\w]/, !1)) return E('async', 'keyword', x);
                }
        ...
        var J = { atom: !0, number: !0, variable: !0, string: !0, regexp: !0, this: !0, import: !0, 'jsonld-keyword': !0 };
        function te(s, p, A, x, I, Y) {
            ((this.indented = s), (this.column = p), (this.type = A), (this.prev = I), (this.info = Y), x != null && (this.align = x));
        }
        function ne(s, p) {
            if (!l) return !1;
        ...
        function Q(s, p, A, x, I) {
            var Y = s.cc;
            for (h.state = s, h.stream = I, h.marked = null, h.cc = Y, h.style = p, s.lexical.hasOwnProperty('align') || (s.lexical.align = !0); ; ) {
                      ...
                      : s == 'debugger'
                        ...
                        : s == '{'
                          ...
                          : s == ';'
                            ? f()
                            : s == 'if'
                              ? (h.state.lexical.info == 'else' && h.state.cc[h.state.cc.length - 1] == N && h.state.cc.pop()(), f(B('form'), kt, ee, N, $i))
                              : s == 'function'
                                ? f(_t)
                                : s == 'for'
                                  ...
                                  : s == 'class' || (c && p == 'interface')
                                    ...
                                    : s == 'variable'
                                      ? c && p == 'declare'
                                          ...
                                          : c && (p == 'module' || p == 'enum' || p == 'type') && h.stream.match(/^\s*\w/, !1)
                                            ? ((h.marked = 'keyword'),
                                              p == 'enum' ? f(Wi) : p == 'type' ? f(Ri, q('operator'), V, q(';')) : f(B('form'), Fe, q('{'), B('}'), Hn, N, N))
                                            : c && p == 'namespace'
        ...
        function ht(s, p, A) {
            ...
            if (s != ';') {
                ...
                if (s == 'regexp') return ((h.state.lastType = h.marked = 'operator'), h.stream.backUp(h.stream.pos - h.stream.start - 1), f(I));
            }
        }
        function St(s, p) {
        ...
        function it(s) {
            return function (p) {
                return p == '.' ? f(s ? Fn : Ut) : p == 'variable' && c ? f(ca, s ? ht : rt) : C(s ? je : W);
            };
        }
        function Ut(s, p) {
        ...
        function Ct(s, p) {
            ...
            if (s == 'variable' || h.style == 'keyword') {
                ...
                var A;
                return (
                    c && h.state.fatArrowAt == h.stream.start && (A = h.stream.match(/^\s*:\s*/, !1)) && (h.state.fatArrowAt = h.stream.pos + A[0].length),
                    f(Ge)
                );
            } else {
        ...
        function V(s, p) {
            if (p == 'keyof' || p == 'typeof' || p == 'infer' || p == 'readonly') return ((h.marked = 'keyword'), f(p == 'typeof' ? je : V));
        ...
        function Cr(s, p) {
            return (s == 'variable' && h.stream.match(/^\s*[?:]/, !1)) || p == '?' ? f(Cr) : s == ':' ? f(V) : s == 'spread' ? f(Cr) : C(V);
        }
        function ot(s, p) {
        ...
        function Hi(s, p) {
            return s == 'variable' && !h.stream.match(/^\s*:/, !1)
                ...
                : (s == 'variable' && (h.marked = 'property'),
                  s == 'spread' ? f(Fe) : s == '}' ? C() : s == '[' ? f(W, q(']'), q(':'), Hi) : f(q(':'), Fe, At));
        }
        function pa() {
            return C(Fe, At);
        }
        ...
        function Wt(s, p) {
            return s == ')' ? f() : s == ';' ? f(Wt) : p == 'in' || p == 'of' ? ((h.marked = 'keyword'), f(W, Wt)) : C(W, Wt);
        }
        function _t(s, p) {
        ...
        function Dt(s, p) {
            return (p == '@' && f(W, Dt), s == 'spread' ? f(Dt) : c && xe(p) ? ((h.marked = 'keyword'), f(Dt)) : c && s == 'this' ? f(Gt, At) : C(Fe, Gt, At));
        }
        function da(s, p) {
        ...
        function Kn(s, p) {
            ...
            if (p == 'extends' || p == 'implements' || (c && s == ',')) return (p == 'implements' && (h.marked = 'keyword'), f(c ? V : W, Kn));
            if (s == '{') return f(B('}'), at, N);
        }
        function at(s, p) {
            if (s == 'async' || (s == 'variable' && (p == 'static' || p == 'get' || p == 'set' || (c && xe(p))) && h.stream.match(/^\s+[\w$\xa1-\uffff]/, !1)))
        ...
        function Rn(s, p) {
            return s == '{' ? un(Rn, '}') : (s == 'variable' && Ee(p), p == '*' && (h.marked = 'keyword'), f(ha));
        }
        function Gi(s) {
            if (s == ',') return f(Rn, Gi);
        }
        ...
        function Vi(s, p, A) {
            return (
                (p.tokenize == O && /^(?:operator|sof|keyword [bcd]|case|new|export|default|spread|[\[{}\(,;:]|=>)$/.test(p.lastType)) ||
        ...
        return {
            ...
            token: function (s, p) {
                if (
                    (s.sol() && (p.lexical.hasOwnProperty('align') || (p.lexical.align = !1), (p.indented = s.indentation()), F(s, p)),
                    p.tokenize != K && s.eatSpace())
                )
                    return null;
                var A = p.tokenize(s, p);
                return S == 'comment' ? A : ((p.lastType = S == 'operator' && (k == '++' || k == '--') ? 'incdec' : S), Q(p, A, S, k, s));
            },
            indent: function (s, p) {
...
(function (n) {
    ...
    n.customOverlayMode = function (e, t, r) {
        return {
            startState: function () {
                return { base: n.startState(e), overlay: n.startState(t), basePos: 0, baseCur: null, overlayPos: 0, overlayCur: null, streamSeen: null };
            },
            ...
            token: function (i, o) {
                return (
                    (i != o.streamSeen || Math.min(o.basePos, o.overlayPos) < i.start) && ((o.streamSeen = i), (o.basePos = o.overlayPos = i.start)),
                    i.start == o.basePos && ((o.baseCur = e.token(i, o.base)), (o.basePos = i.pos)),
                    i.start == o.overlayPos && ((i.pos = i.start), (o.overlayCur = t.token(i, o.overlay)), (o.overlayPos = i.pos)),
                    (i.pos = Math.min(o.basePos, o.overlayPos)),
                    o.baseCur &&
                        o.overlayCur &&
                        o.baseCur.contains('line-HyperMD-codeblock') &&
                        ((o.overlayCur = o.overlayCur.replace('line-templater-inline', '')), (o.overlayCur += ' line-background-HyperMD-codeblock-bg')),
                    o.overlayCur == null
                        ? o.baseCur
            ...
            blankLine: function (i) {
                let o, a;
                return (
                    e.blankLine && (o = e.blankLine(i.base)), t.blankLine && (a = t.blankLine(i.overlay)), a == null ? o : r && o != null ? o + ' ' + a : a
                );
            },
        };
    };
    ...
    Fi = class {
        ...
        async setup() {
            ((this.autocomplete = new Mi(this.plugin)),
                ...
                (this.templaterLanguage = na.Prec.high(ta.StreamLanguage.define(window.CodeMirror.getMode({}, ra)))),
                this.templaterLanguage === void 0 && oe(new P('Unable to enable syntax highlighting. Could not define language.')),
        ...
        async disable_highlighter() {
            this.activeEditorExtensions.length > 0 && (this.activeEditorExtensions.pop(), this.plugin.app.workspace.updateOptions());
        }
        async jump_to_next_cursor_location(e = null, t = !1) {
            (t && !this.plugin.settings.auto_jump_to_cursor) || (e && vt(this.plugin.app) !== e) || (await this.cursor_jumper.jump_to_next_cursor_location());
        }
            ...
            window.CodeMirror.defineMode(ra, function (r) {
                let i = {
                    ...
                    copyState: function (o) {
                        return { ...window.CodeMirror.startState(e), inCommand: o.inCommand, tag_class: o.tag_class, freeLine: o.freeLine };
                    },
...
var qi = class extends Tr.Plugin {
    ...
    async save_settings() {
        (await this.saveData(this.settings), this.editor_handler.updateEditorIntellisenseSetting(this.settings.intellisense_render));
    }
    async load_settings() {
