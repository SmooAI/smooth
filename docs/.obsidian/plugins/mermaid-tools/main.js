    ...
    save() {
        ...
        if (!commonDiagramTypes.includes(wrapping)) {
            const shouldContinue = confirm(
                `Warning: "${wrapping}" is not a recognized Mermaid diagram type. This may cause rendering errors. Are you sure you want to continue?`,
            );
            if (!shouldContinue) {
                return;
            }
...
Start --> Stop`,
        ...
        deleteButton.onclick = (e) => {
            ...
            if (elementsInCategory.length > 0) {
                alert(
                    `Cannot delete category '${category.name}' because it contains ${elementsInCategory.length} element(s). Please move or delete these elements first.`,
                );
                return;
            }
    ...
    constructor(leaf, plugin) {
        ...
        this.topRowButtons = [
            new MermaidToolbarButton('insert Mermaid code block with sample diagram', 'code-2', () =>
                this.insertTextAtCursor(this._plugin._mermaidElementService.getSampleDiagram(this._plugin.settings.selectedCategoryId)),
            ),
