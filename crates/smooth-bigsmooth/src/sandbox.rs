...
///
/// Microsandbox is the only sandbox backend Smooth supports. Direct
/// mode (`th up direct` / `SMOOTH_WORKFLOW_DIRECT=1`) is handled at
/// the dispatch level — it runs the agent as a host subprocess and
/// never calls into this client.
///
